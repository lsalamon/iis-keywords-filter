...
**
*/
static int boInitBITOP(BITOP *BitOp, int iSize)
{
    int iBytes;
...
**
*/
static int boResetBITOP(BITOP *BitOp)
{
...
**
*/
static int boSetBit(BITOP *BitOp, int iPos)
{
    unsigned char mask;
...
**
*/
static int boIsBitSet(BITOP *BitOp, int iPos)
{
    unsigned char mask;
...
**
*/
static void boClearBit(BITOP *BitOp, int iPos)
{
    unsigned char mask;
...
**
*/
static void boClearByte(BITOP *BitOp, int iPos)
{
    /*
